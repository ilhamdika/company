                  ...
                  </li> */}
                  {
                    Menu.map((menu)=>(
                      <li key={menu.name} className='text-xl tablet:my-0 my-7' onClick={() => handleClick(menu.link)}>
                        <Link href={route(menu.link)} className={`dark:text-white text-black hover:text-cyan-400 duration-500 ml-2 mr-5 ${menu.link === activeMenu ? 'font-semibold border-b-2 border-black dark:border-white' : 'hover:border-b-2'}`}>
                          {menu.name}
                        </Link>
                      </li>
                    ))
                  }
                  <li className={`text-xl tablet:my-0 my-7 mobile:my-7 ${'user.berita' === activeMenu  || 'user.artikel' ===  activeMenu ? 'font-semibold border-b-2 border-black dark:border-white' : 'hover:border-b-2'}`}>
