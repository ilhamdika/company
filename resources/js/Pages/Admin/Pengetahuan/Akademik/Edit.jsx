...
export default function Edit ({auth, akademik}){
    ...
    const submit = (e) => {
        ...
        if(data.image === akademik.image){
            delete data.image;
        }

        Inertia.post(route('admin.dashboard.akademik.update', akademik.id),{
            _method: 'PUT',
            ...data
        });
    };
