...
export default function Edit ({auth, bentuk_kerjasama}){
    ...
    const submit = (e) => {
        ...
        if(data.image === bentuk_kerjasama.image){
            delete data.image;
        }

        Inertia.post(route('admin.dashboard.bentuk-kerjasama.update', bentuk_kerjasama.id),{
            _method: 'PUT',
            ...data
        });
    }
        ...
        <Authenticated auth={auth}>
            ...
            <form onSubmit={submit}>
                ...
                <TextArea
                    ...
                    defaultValue={bentuk_kerjasama.title}
                />
