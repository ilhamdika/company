...
export default function Index() {
    ...
    return <LayoutPage>
     ...
     data-aos-duration="1500" >Layanan satpam kami tidak hanya melibatkan pengawasan, tetapi juga pencegahan dan respons cepat."</h1>
                            <p className="mt-10" data-aos="zoom-out-left">Jaga Properti Anda dengan Layanan Satpam Terbaik.</p>
     ...
     data-aos-anchor-placement="top-bottom">
            ...
            <div className="grid grid-cols-2 laptop:flex-row dekstop:flex-row mobile:grid-cols-1 mt-3 bg-gray-100 dark:bg-slate-600 rounded-xl">
                    <div className="flex items-center justify-center pt-10 pb-10 px-1">
                        <h1 className="dark:text-white" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">Solusi kebutuhan keamanan Anda bukan hanya sekedar perlindungan fisik. Kami melindungi Anda lebih jauh dengan framework terintegrasi yang terdiri dari Plan-Prevent-Protect, solusi komprehensif untuk melindungi aset berharga Anda dan mencegah kerugian.</h1>
                    </div>
                    <div className=' pt-10 pb-10 px-1'>
                        <h1 className="font-semibold text-4xl dark:text-white" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="500">Kami memastikan keamanan Anda lebih dari sekedar perlindungan.</h1>
                    </div>
            </div>
     ...
     data-aos-offset="300"
     data-aos-easing="ease-in-sine">25+ tahun menjaga aset Anda di berbagai penjuru negeri.</h1>
                    </div>
                    <div className=' pt-10 pb-10 px-1'>
