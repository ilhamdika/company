...
export default function Karir({rekruitmens, administrasis, mental_ideologis, kemampuan_fisiks, tugas_pokoks, fisik_mentals, akademiks, keterampilans, bentuk_kerjasamas}) {
    ...
    return (
        <LayoutPage>
            <Head title="Karir" />
            <div className="mobile:pt-14 w-full">
        ...
        <div className="grid grid-cols-2 laptop:flex-row dekstop:flex-row mobile:grid-cols-1 mt-3 px-10 mobile:px-1">
                        <div className='mt-10 mobile:h-100 mobile:w-full'>
                            <img src="/images/karir2.png" alt="Elemen Atas" className="px-10 w-auto h-auto"/>
                            {/* <h1 className="font-semibold text-xl dark:text-white mt-2" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500" >Materi Dan Kemampuan Pengetahuan Tenaga Jasa Pengamanan</h1>
                            <p className="pt-5 dark:text-white" data-aos="fade-left" data-aos-easing="linear" data-aos-duration="1500" >PT. Daya Wineka Sejahtera Nusantara telah mempersiapkan pemuda/pemudi yang di didik dan diberi kemampuan pengetahuan bidang satpam agar menjadi satuan pengamanan yang terampil dan profesional dalam tugasnya</p> */}
                        </div>
                        <div className="flex items-center justify-center pt-10 pb-10">
                            <div className=" dark:text-white rounded-md">
                                <div className="items-left justify py-2">
                                    ...
                                    {fisik_mentals.map((tugas, i = 1) => (
                                        <p className="mt-2 dark:text-white pl-4" data-aos="fade-left" key={tugas.id}><span className="font-semibold">{i+1}. </span>{tugas.title}</p>
                                    ))}
        ...
        {/* <div className="grid grid-cols-2 laptop:flex-row dekstop:flex-row mobile:grid-cols-1 mt-10 mobile:mt-20">
                <div className="items-left justify mx-auto py-2">
                    ...
                    <h1 className="font-light text-xl dark:text-white mt-3" data-aos="fade-up-right">PT. Daya Wineka Sejahtera Nusantara telah mempersiapkan pemuda/pemudi yang di didik dan diberi kemampuan pengetahuan bidang satpam agar menjadi satuan pengaman yang terampil dan profesional dalam bidang tugasnya</h1>
                    <img src="/images/logo.png" alt="Elemen Atas" className="py-10 w-20"/>
                </div>
                <div className="items-left justify py-2">
                    <h1 className="font-semibold text-2xl dark:text-white mt-2">Fisik dan mental</h1>
                    {fisik_mentals.map((tugas, i = 1) => (
                        <p className="mt-2 dark:text-white" data-aos="fade-left" key={tugas.id}><span className="font-semibold">{i+1}. </span>{tugas.title}</p>
                    ))}
                    <h1 className="font-semibold text-2xl dark:text-white mt-2">Akademik</h1>
                    {akademiks.map((tugas, i = 1) => (
                        <p className="mt-2 dark:text-white" data-aos="fade-left" key={tugas.id}><span className="font-semibold">{i+1}. </span>{tugas.title}</p>
