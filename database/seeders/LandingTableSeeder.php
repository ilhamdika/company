...
class LandingTableSeeder extends Seeder
{
    ...
    public function run()
    {
        Landing::create([
            ...
            'branding_sub' => 'Dakara didirikan oleh sekelompok lulusan angkatan ke-9 Akademi Kepolisian Indonesia di tahun 1996. Dengan 25+ tahun pengalaman, Nawakara telah dikenal dalam skala global dengan cabang di berbagai wilayah Indonesia.',
        ]);
    }
}
